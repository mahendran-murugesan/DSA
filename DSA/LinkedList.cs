...
public class CustomLinkedList<T> : IEnumerable<Node<T>>
    {
        ...
        private void AddFirst(Node<T> nodeToAdd)
        {
            if (First is null)
            {
                First = nodeToAdd;
        ...
        private void AddAfter(Node<T> nodeToAdd, T valueToFind)
        {
        ...
        private void AddLast(Node<T> nodeToAdd)
        {
        ...
        private void AddBefore(Node<T> nodeToAdd, T valueToFind)
        {
            var find = Find(valueToFind);
